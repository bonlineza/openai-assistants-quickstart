    ...
    const assistant = await openai.beta.assistants.create({
      ...
      tools: [
        { type: "code_interpreter" },
        {
          ...
          function: {
            name: "get_order",
            description: "Get the details of a purchase order based on the passed order number.",
            parameters: {
              type: "object",
              properties: {
                order_number: {
